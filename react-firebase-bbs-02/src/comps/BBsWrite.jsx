...
// props.history
/**
 * react-router-dom을 사용하여 Routing을 구현하고
 ...
 * 매개변수를 지정하지 않고 use 함수를 사용하여 history를
 * 사용할 수 있다.
 *
...
function BBsWrite() {
  ...
  // onChage Event 핸들러
  // 키보드 입력한 데이터를 bbs 객체에 setting 하는 일을 수행한다
  const onChange = (e) => {
  ...
  const onClickSave = () => {
    ...
    const saveBBs = {
      ...bbs,
      // bbs.b_date의 값이 "" 이
      // 	아니면 bbs.b_date를 b_date칼럼에 저장하고
      // bbs.b_date의 값이 "" 이면
