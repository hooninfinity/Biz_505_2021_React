...
const atlasURL =
  `mongodb+srv://` +
  `${USERID}` +
  `:${PASSWORD}@cluster0.6wur6.mongodb.net/` +
...
// API 서버를 구축할때는 필수적으로 CORS를 허용해줘야 한다
// Nodejs에서는 cors import하여 단순 설정만 하여도 CORS를 허용할수 있다
// 무작정 CORS를 허용하는 것은 매우 위험한 정책이다.
// 필요한 곳만 CORS를 허용하도록 설정을 한다

// 허용할 접속주소(URL) 설정하기 위한 허용주소록 만들기
const whiteURLs = ["http://localhost:3000", "https://hoon.com:15500"];
